...
namespace KontrolaKadi
{
    public class Prop17
    {
        ...
        public Prop17(Sharp7.S7Client client)
        {
             Client = client;
             Nivo14= new PlcVars.Bit(Client, "bit at 310.0", "OK", "NAPAKA", false);
             ...
             DeltaOn14= new PlcVars.Word(Client, "W 370", "", "°C", true);
             ...
             DelovanjeFilterCrpalke14= new PlcVars.Bit(Client, "bit at 376.0", "Aktivno", "Ni aktivno", false);
             ...
             PhOverLimitForAlarm14= new PlcVars.PhShow(Client, "W 446", "Ph ", "", 0, 0.1F, true);
             PhUnderLimitForAlarm14= new PlcVars.PhShow(Client, "W 448", "Ph ", "", 0, 0.1F, true);
             AlarmPh14= new PlcVars.Bit(Client, "bit at 450.0", "ALARM", "OK", false);
             CanStartGrelec14= new PlcVars.Bit(Client, "bit at 472.0", "Pripravljen", "Čaka", false);
             CanStartCrpalka14= new PlcVars.Bit(Client, "bit at 458.0", "Pripravljen", "Čaka", false);
             MocFiltracijskeCrpalke14= new PlcVars.PowerShow(Client, "W 444", "", "W", 0, 1, true);
             SkupnaPorabaKadi14= new PlcVars.Word(Client, "W 480", "", "", false);
            ...
            try
            {
                if (Main_datagrid != null)
                {
                    if (Main_datagrid.Rows.Count > 0)
                    {
                        ...
                        MocGrelca14.SyncWithPC(Main_datagrid[1, 17]);
                        ...
                        MocFiltracijskeCrpalke14.SyncWithPC(Main_datagrid[1, 19]);
