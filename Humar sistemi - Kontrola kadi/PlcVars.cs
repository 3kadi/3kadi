...
namespace KontrolaKadi
{
    public class PlcVars
    {
        public class Word
        {
            ...
            public void SyncWithPC(DataGridViewCell dataGridViewCell)
            {
                try
                {
                    WriteToPCFromBuffer(dataGridViewCell);
                }
                catch { }

                try
                {
                    if (dataGridViewCell.Value.ToString() != PropComm.NA)
                    {
                        if (dataGridViewCell.Value.ToString() != null)
                        {
                            ReadFromPCtoBuffer(Convert.ToInt16(
                                RemoveFromBegining(
                                    RemoveFromEnd(
                                        dataGridViewCell.Value.ToString(), _postFixToShow), _prefixToShow)), false);
                        }
                    }
                }
                catch
            ...
            private void WriteToPCFromBuffer(DataGridViewCell dataGridViewCell)
            {
                if (directionToPLC == false)
                {
                    if (PLCval != null)
                    {
                        ...
                        {
                            dataGridViewCell.Value = (_prefixToShow + PLCval + _postFixToShow).ToString();
                            datacorrupted = false;
                        }
                        if (dataGridViewCell.Value.ToString() != (_prefixToShow + PLCval + _postFixToShow).ToString())
                        {
        ...
        public class TimeSet
        {
            ...
            public void SyncWithPC(DataGridViewCell dataGridViewCell, int method)
            {
                ...
                try
                {
                    WriteToPCFromBuffer(dataGridViewCell,  method);
                }
                catch { }
                ...
                try
                {
                    if (dataGridViewCell.Value.ToString() != PropComm.NA)
                    {
                        if (dataGridViewCell.Value.ToString() != null)
                        {
                            ReadFromPCtoBuffer(EncodeWordToTime(dataGridViewCell.Value.ToString()), false);
                        }
                    }
                }
                catch
            ...
            private void WriteToPCFromBuffer(DataGridViewCell dataGridViewCell, int method)
            {
                // method = 1 - Siemens Logo week timer
                // method = 2 - Used to get clock from Siemens Logo
                ...
                if (directionToPLC == false)
                {
                    if (PLCval != null)
                    {
                        if (PLCval != PCval || datacorrupted == true)
                        {
                            dataGridViewCell.Value = DecodeWordToTime((short)PLCval, method).ToString();
                            datacorrupted = false;
                        }
                        if (dataGridViewCell.Value.ToString() != DecodeWordToTime((short)PLCval, method).ToString())
                        {                            
                            datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop
                        }
                    }
            ...
            public void SyncWithPC(DataGridViewCell dataGridViewCell)
            {
                ...
                try
                {
                    if (dataGridViewCell.Value.ToString() != PropComm.NA)
                    {
                        if (dataGridViewCell.Value.ToString() != null)
                        {
                            ReadFromPCtoBuffer(Convert.ToInt16(dataGridViewCell.Value));
                        }
                    }
                }
                catch
            ...
            private void WriteToPCFromBuffer(DataGridViewCell dataGridViewCell)
            {
                if (directionToPLC == false)
                {
                    if (PLCval != null)
                    {
                        ...
                        if (((bool)dataGridViewCell.Value == false && PLCval > 0) || ((bool)dataGridViewCell.Value == true && PLCval == 0))
                        {
                            datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop
                        }
                    }
        ...
        public class Bit
        {
            ...
            public void SyncWithPC(DataGridViewCell dataGridViewCell)
            {
                ...
                try
                {
                    ...
                    if (dataGridViewCell is DatagridTypes.CheckBox)
                    {
                        if (dataGridViewCell.Value != null)
                        {
                            ReadFromPCtoBuffer(Convert.ToBoolean(dataGridViewCell.Value), false);
                            return;
                        }
                    }
                    else
                    {
                        if (dataGridViewCell.Value.ToString() != PropComm.NA)
                        {
                            ...
                            if (dataGridViewCell.Value.ToString() != null)
                            {
                                if (dataGridViewCell.Value.ToString() == _replacementTextIfTrue)
                                {
                                    ReadFromPCtoBuffer(true, false);
                                    return;
                                }
                                if (dataGridViewCell.Value.ToString() == _replacementTextIfFalse)
                                {
                ...
                if (directionToPLC == false)
                {
                    if (PLCval != null)
                    {
                        if (PLCval != PCval || datacorrupted)
                        {
                            ...
                            if (PLCval == true)
                            {
                                dataGridViewCell.Value = _replacementTextIfTrue;
                                datacorrupted = false;
                                if (dataGridViewCell.Value.ToString() != _replacementTextIfTrue)
                                {
                                    datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop
                            ...
                            {
                                dataGridViewCell.Value = _replacementTextIfFalse;
                                datacorrupted = false;
                                if (dataGridViewCell.Value.ToString() != _replacementTextIfFalse)
                                {
                                    datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop
                    ...
                    if (PLCval != null)
                    {
                        if (PLCval != PCval || datacorrupted)
                        {
                            if (PLCval == true)
                            {
                                dataGridViewCell.Value = true;
                                datacorrupted = false;
                                if (Convert.ToBoolean(dataGridViewCell.Value) != true)
                                {
                                    datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop
                                }
                            }
                            else
                            {
                                dataGridViewCell.Value = false;
                                datacorrupted = false;
                                if (Convert.ToBoolean(dataGridViewCell.Value) != false)
                                {
                                    datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop
                                }
                            }
            ...
            public void SyncWithPC(DataGridViewCell dataGridViewCell)
            {
                ...
                try
                {
                    if (dataGridViewCell.Value.ToString() != PropComm.NA)
                    {
                        if (dataGridViewCell.Value.ToString() != null)
                        {
                            var a = DeScalate(dataGridViewCell.Value.ToString());
            ...
            private void WriteToPCFromBuffer(DataGridViewCell dataGridViewCell)
            {
                if (directionToPLC == false)
                {
                    if (PLCval != null)
                    {
                        if (PLCval != PCval || datacorrupted == true)
                        {
                            dataGridViewCell.Value = (_prefixToShow + Scalate(PLCval) + _postFixToShow).ToString();
                            datacorrupted = false;
                        }

                        if (dataGridViewCell.Value.ToString() != (_prefixToShow + Scalate(PLCval) + _postFixToShow).ToString())
                        {
                            datacorrupted = true; // if displayed data is not as it should be they are overwriten next loop                                                            
                        }
                    }
