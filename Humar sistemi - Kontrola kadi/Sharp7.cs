...
namespace Sharp7
{
    ...
    public static class S7Consts
    {
        ...
        //                                     ERRORS                 
        //------------------------------------------------------------------------------
        public const int err_UnspecifiedHigherLayer   = -100;   // added later
        public const int err_cantConnect              = -8;     // added later
        public const int err_typeError                = -7;     // added later
        public const int err_WriteHigherLayer         = -6;    // added later 
        public const int err_ReadHigherLayer          = -5;    // added later 
        public const int err_Write                    = -4;     // added later 
        public const int err_Read                     = -3;     // added later 
        public const int err_watchdogDoesntChange     = -2;     // added later 

        public const int err_OK                       = 0;      // added later 
    ...
    public class S7Client
    {
        ...
        public string ErrorText(int Error)
        {
            switch (Error)
            {
                ...
                case S7Consts.err_WriteHigherLayer: return "Can not write data from PLC. Error ocurded in higher layer of communication. Please contact your SW supplier.";          // added later
                case S7Consts.err_ReadHigherLayer: return "Can not read data from PLC. Error ocurded in higher layer of communication. Please contact your SW supplier.";            // added later
                case S7Consts.err_Write: return "Can not write data from PLC";                               // added later 
                case S7Consts.err_Read: return "Can not read data from PLC";                                 // added later 
                case S7Consts.err_watchdogDoesntChange: return "Watchdog error - Watchdog does not change"; // added later 
                case S7Consts.err_typeError: return "Type error - unsupported type wanted";                  // added later

                case S7Consts.err_OK: return "OK";
